...
- Xóa toàn bộ sample task, placeholder và instructional example khỏi generated `tasks.md`.
- Generated `tasks.md` chỉ chứa task thật của feature và các summary section cần thiết.
